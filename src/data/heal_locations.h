static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SAND_PEARL_TOWN - 1] = {MAP_GROUP(SAND_PEARL_TOWN), MAP_NUM(SAND_PEARL_TOWN), 7, 11},
    [HEAL_LOCATION_NEAR_SAND_TOWN - 1] = {MAP_GROUP(NEAR_SAND_TOWN), MAP_NUM(NEAR_SAND_TOWN), 9, 15},
    [HEAL_LOCATION_COOL_LAKE_CITY - 1] = {MAP_GROUP(COOL_LAKE_CITY), MAP_NUM(COOL_LAKE_CITY), 34, 28},
};
